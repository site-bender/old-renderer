import { g as getRenderingRef, f as forceUpdate, h } from './index-d29ca497.js';
...
function getItemPropAttributes(itemprops) {
  return {
...
*/
const Abbreviation = (_a) => {
  var { anchorStyle, children, componentId, contentEditable, dir, draggable, enterKeyHint, expansion, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target } = _a, config = __rest$u(_a, ["anchorStyle", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "expansion", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", { class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId, referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target },
    h("abbr", Object.assign({ contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: expansion }), children))) : (h("abbr", Object.assign({ contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputmode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, title: expansion }), children));
};

function parseItemIntoComponent(item) {
  const [, id] = item.match(/^<item id="([0-9A-Za-z_-]{21})"/);
  return id ? h(ComponentRenderer, { componentId: id }) : item;
}

function injectComponentsIntoContent(content = '') {
  const parts = content.split(/(<item id="[0-9A-Za-z_-]{21}">[^<]*<\/item>)/);
  return parts.map(part => part.slice(0, 8) === '<item id' ? parseItemIntoComponent(part) : part);
}
...
*/
const Anchor = (_a) => {
  var { children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$t(_a, ["children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return (h("a", Object.assign({ class: "anchor-bender", contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, href: href, hreflang: hrefLang, id: componentId, inputmode: inputMode }, itemprops, { lang: lang, referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex || 0, target: target, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Citation = (_a) => {
  var { ariaAnchorRole, autoCapitalize, children, citationType, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, hrefLang, inputMode, 
  // inTextType,
  lang, referentId, 
  // referentType,
  referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$s(_a, ["ariaAnchorRole", "autoCapitalize", "children", "citationType", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "hrefLang", "inputMode", "lang", "referentId", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return citationType === 'footnote' ? (h("a", Object.assign({ autocapitalize: autoCapitalize, class: "citation-anchor", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, href: `#${referentId}`, hreflang: hrefLang, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, referrerPolicy: referrerPolicy, rel: getRel(rel), role: ariaAnchorRole, spellcheck: spellCheck, style: style, tabIndex: tabIndex || 0, target: target, title: title }),
    h("span", { class: "footnote-marker" }))) : (h("cite", Object.assign({ autocapitalize: autoCapitalize, class: "citation-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Code = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$r(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("code", { autocapitalize: autoCapitalize, class: "code-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("code", Object.assign({ autocapitalize: autoCapitalize, class: "code-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const CodeBlock = (_a) => {
  var { autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, inputMode, lang, language, role, spellCheck, style, tabIndex, title } = _a, config = __rest$q(_a, ["autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "inputMode", "lang", "language", "role", "spellCheck", "style", "tabIndex", "title"]);
  const itemprops = getItemPropAttributes(config);
  return (h("pre", null,
    h("code", Object.assign({ autocapitalize: autoCapitalize, class: `code-block-bender ${language ? language : ''}`, contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children))));
};
...
*/
const DefinedTerm = (_a) => {
  var { abbreviation, anchorStyle, autoCapitalize, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, term } = _a, config = __rest$p(_a, ["abbreviation", "anchorStyle", "autoCapitalize", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "term"]);
  const itemprops = getItemPropAttributes(config);
  const output = abbreviation ? h("abbr", { title: term }, abbreviation) : term;
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("dfn", { autocapitalize: autoCapitalize, class: "defined-term-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style }, output))) : (h("dfn", Object.assign({ autocapitalize: autoCapitalize, class: "defined-term-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style }), output));
};
...
/*
  Deletion represents a range of text that has been deleted from a document.
  ...
  Accepts anything that will still be valid if the enclosing Deletion
  component is stripped away (transparent).
*/
const Deletion = (_a) => {
  var { anchorStyle, autoCapitalize, children, cite, componentId, contentEditable, dateTime, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$o(_a, ["anchorStyle", "autoCapitalize", "children", "cite", "componentId", "contentEditable", "dateTime", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target, title: title }),
    h("del", { autocapitalize: autoCapitalize, cite: cite, class: "deletion-bender", contentEditable: contentEditable, datetime: dateTime, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style }, injectComponentsIntoContent(children)))) : (h("del", Object.assign({ autocapitalize: autoCapitalize, cite: cite, class: "deletion-bender", contentEditable: contentEditable, datetime: dateTime, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const EmailAddress = (_a) => {
  var { anchorStyle, componentId, contentEditable, dir, draggable, emailAddress, enterKeyHint, hidden, inputMode, lang, mailto, referrerPolicy, rel, spellCheck, style, tabIndex, target, title } = _a, config = __rest$n(_a, ["anchorStyle", "componentId", "contentEditable", "dir", "draggable", "emailAddress", "enterKeyHint", "hidden", "inputMode", "lang", "mailto", "referrerPolicy", "rel", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return mailto ? (h("a", { class: "anchor-bender", draggable: draggable, hidden: hidden, href: `mailto:${emailAddress}`, id: componentId, referrerPolicy: referrerPolicy, rel: getRel(rel), style: anchorStyle, tabIndex: tabIndex || 0, target: target },
    h("span", Object.assign({ class: "email-address-bender", contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }), emailAddress))) : (h("span", Object.assign({ class: "email-address-bender", contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }), emailAddress));
};
...
*/
const Emphasize = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, level, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$m(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "level", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  // Default to weak emphasis
  const Tag = level === 'strong' ? 'strong' : 'em';
  // Wrap both for double emphasis
  const content = level === 'double' ? (h("strong", null, injectComponentsIntoContent(children))) : (injectComponentsIntoContent(children));
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h(Tag, { autocapitalize: autoCapitalize, class: "emphasize-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, content))) : (h(Tag, Object.assign({ autocapitalize: autoCapitalize, class: "emphasize-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), content));
};
...
*/
const FinePrint = (_a) => {
  var { autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, inputMode, lang, role, spellCheck, style, tabIndex, title } = _a, config = __rest$l(_a, ["autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "inputMode", "lang", "role", "spellCheck", "style", "tabIndex", "title"]);
  const itemprops = getItemPropAttributes(config);
  return (h("small", Object.assign({ autocapitalize: autoCapitalize, class: "fine-print-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};

function getLanguage(lang) {
  const [language] = lang.split('-');
  const languageCode = lang ? language.toLowerCase() : '';
...
/*
  ...
  Accepts phrasing content.
*/
const ForeignTerm = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, language, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, translation } = _a, config = __rest$k(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "language", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "translation"]);
  const itemprops = getItemPropAttributes(config);
  const titleText = language && translation
    ? `${getLanguage(language)}: ${translation}`
    : translation || getLanguage(language);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("span", { autocapitalize: autoCapitalize, class: "foreign-term-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: titleText }, injectComponentsIntoContent(children)))) : (h("span", Object.assign({ autocapitalize: autoCapitalize, class: "foreign-term-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: titleText }), injectComponentsIntoContent(children)));
};
...
const index_umd$1 = /*@__PURE__*/getDefaultExportFromCjs(index_umd);

function plainDate(d) {
  if (d instanceof index_umd.Temporal.PlainDate) {
    return d;
  }
  if (typeof d === 'undefined') {
    return undefined;
  }
  const date = (d instanceof Date && index_umd.Temporal.PlainDate.from(d.toISOString())) ||
    index_umd.Temporal.PlainDate.from(d);
  return date;
}
...
function formatDate(date, options = {}) {
  var _a;
  const { locale = 'en-NZ', day = 'numeric', month = 'short', year = 'numeric' } = options, format = __rest$j(options, ["locale", "day", "month", "year"]);
  return (_a = plainDate(date)) === null || _a === void 0 ? void 0 : _a.toLocaleString(locale, Object.assign({ day,
    month,
    year }, format));
}
...
/*
  ...
  Accepts no children.
*/
const FormattedDate = (_a) => {
  var { anchorStyle, autoCapitalize, componentId, contentEditable, date, dir, draggable, enterKeyHint, format, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$i(_a, ["anchorStyle", "autoCapitalize", "componentId", "contentEditable", "date", "dir", "draggable", "enterKeyHint", "format", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("time", { autocapitalize: autoCapitalize, class: "formatted-date-bender", contentEditable: contentEditable, dateTime: date, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, formatDate(date, format)))) : (h("time", Object.assign({ autocapitalize: autoCapitalize, class: "formatted-date-bender", contentEditable: contentEditable, dateTime: date, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), formatDate(date, format)));
};

function plainDateTime(d) {
  if (d instanceof index_umd.Temporal.PlainDateTime) {
    return d;
  }
  if (typeof d === 'undefined') {
    return undefined;
  }
  const dateTime = (d instanceof Date && index_umd.Temporal.PlainDateTime.from(d.toISOString())) ||
    index_umd.Temporal.PlainDateTime.from(d);
  return dateTime;
}
...
function formatDateTime(dateTime, options = {}) {
  var _a;
  const { locale = 'en-NZ', day = 'numeric', month = 'long', year = 'numeric', hour = 'numeric', minute = '2-digit' } = options, format = __rest$h(options, ["locale", "day", "month", "year", "hour", "minute"]);
  return (_a = plainDateTime(dateTime)) === null || _a === void 0 ? void 0 : _a.toLocaleString(locale, Object.assign({ day,
    month,
    year,
    hour,
    minute }, format));
...
/*
  ...
  Accepts no children.
*/
const FormattedDateTime = (_a) => {
  var { anchorStyle, autoCapitalize, componentId, contentEditable, dateTime, dir, draggable, enterKeyHint, format, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$g(_a, ["anchorStyle", "autoCapitalize", "componentId", "contentEditable", "dateTime", "dir", "draggable", "enterKeyHint", "format", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("time", { autocapitalize: autoCapitalize, class: "formatted-date-time-bender", contentEditable: contentEditable, dateTime: dateTime, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, formatDateTime(dateTime, format)))) : (h("time", Object.assign({ autocapitalize: autoCapitalize, class: "formatted-date-time-bender", contentEditable: contentEditable, dateTime: dateTime, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), formatDateTime(dateTime, format)));
};

function plainTime(t) {
  if (t instanceof index_umd.Temporal.PlainTime) {
    return t;
  }
  if (typeof t === 'undefined') {
    return undefined;
  }
  const dateTime = (t instanceof Date && index_umd.Temporal.PlainTime.from(t.toISOString())) ||
    index_umd.Temporal.PlainTime.from(t);
  return dateTime;
}

function formatTime(time, options = {}) {
  var _a;
  const { locale = 'en-NZ', hour = 'numeric', minute = '2-digit', second = '2-digit', } = options;
  return (_a = plainTime(time)) === null || _a === void 0 ? void 0 : _a.toLocaleString(locale, {
    hour,
    minute,
    second,
  });
...
/*
  ...
  Accepts no children.
*/
const FormattedTime = (_a) => {
  var { anchorStyle, autoCapitalize, componentId, contentEditable, dir, draggable, enterKeyHint, format, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, time, title } = _a, config = __rest$f(_a, ["anchorStyle", "autoCapitalize", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "format", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "time", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("time", { autocapitalize: autoCapitalize, class: "formatted-time-bender", contentEditable: contentEditable, dateTime: time, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, formatTime(time, format)))) : (h("time", Object.assign({ autocapitalize: autoCapitalize, class: "formatted-time-bender", contentEditable: contentEditable, dateTime: time, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), formatTime(time, format)));
};
...
*/
const Heading = (_a) => {
  var { anchorStyle, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, level, referrerPolicy, rel, role, size, spellCheck, style, tabIndex, target, title } = _a, config = __rest$e(_a, ["anchorStyle", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "level", "referrerPolicy", "rel", "role", "size", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  const Tag = `h${level}`;
  return href ? (h(Tag, Object.assign({ class: `h${level}-bender ${size}-bender`, contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }),
    h("a", { class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId, referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }, injectComponentsIntoContent(children)))) : (h(Tag, Object.assign({ class: `h${level}-bender ${size}-bender`, contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputmode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Insertion = (_a) => {
  var { anchorStyle, autoCapitalize, children, cite, componentId, contentEditable, dateTime, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$d(_a, ["anchorStyle", "autoCapitalize", "children", "cite", "componentId", "contentEditable", "dateTime", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target, title: title }),
    h("ins", { autocapitalize: autoCapitalize, cite: cite, class: "insertion-bender", contentEditable: contentEditable, datetime: dateTime, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style }, injectComponentsIntoContent(children)))) : (h("ins", Object.assign({ autocapitalize: autoCapitalize, cite: cite, class: "insertion-bender", contentEditable: contentEditable, datetime: dateTime, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, title: title }), injectComponentsIntoContent(children)));
};

const ItemProp = ({ children, componentId, itemId, itemRef }) => {
  return (h("span", { id: componentId, itemscope: true, itemid: itemId, itemref: itemRef }, injectComponentsIntoContent(children)));
};

const ItemScope = ({ childIds = [], children, componentId, itemId, itemRef, itemType }) => {
  return childIds.length ? (h("div", { id: componentId, itemscope: true, itemid: itemId, itemref: itemRef, itemtype: itemType }, childIds.map(id => (h(ComponentRenderer, { componentId: id }))))) : (h("span", { id: componentId, itemscope: true, itemid: itemId, itemref: itemRef, itemtype: itemType }, injectComponentsIntoContent(children)));
};
...
*/
const Key = (_a) => {
  var { autoCapitalize, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, inputMode, key, lang, spellCheck, style, title } = _a, config = __rest$c(_a, ["autoCapitalize", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "inputMode", "key", "lang", "spellCheck", "style", "title"]);
  const itemprops = getItemPropAttributes(config);
  return (h("kbd", Object.assign({ autocapitalize: autoCapitalize, class: "key-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }), key));
};
...
*/
const KeyboardInput = (_a) => {
  var { anchorStyle, autoCapitalize, children = '', componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, nesting, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$b(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "nesting", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  ...
  const input = nesting === 'key-combo'
    ? children
      .split('+')
      .reduce((acc, key) => [
      ...acc,
      ...(acc.length ? [h("span", null, "+")] : []),
      h("kbd", null, key),
    ], [])
    : children;
  ...
  const kbdText = nesting === 'system' ? h("samp", null, input) : input;
  // KBD attributes depend on whether wrapped in anchor element
  const kbd = href ? (h("kbd", { autocapitalize: autoCapitalize, class: `keyboard-input-bender${cls}`, contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style }, kbdText)) : (h("kbd", Object.assign({ autocapitalize: autoCapitalize, class: `keyboard-input-bender${cls}`, contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, title: title }), kbdText));
  // Nesting a <kbd> element inside a <samp> element represents input
  // that has been echoed back to the user by the system.
  const final = nesting === 'echoed' ? h("samp", null, kbd) : kbd;
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target, title: title }), final)) : (final);
};
...
/*
  ...
  Accepts phrasing content.
*/
const MarkRelevant = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$a(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("mark", { autocapitalize: autoCapitalize, class: "mark-relevant-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("mark", Object.assign({ autocapitalize: autoCapitalize, class: "mark-relevant-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Paragraph = (_a) => {
  var { autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, inputMode, lang, role, spellCheck, style, tabIndex, title } = _a, config = __rest$9(_a, ["autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "inputMode", "lang", "role", "spellCheck", "style", "tabIndex", "title"]);
  const itemprops = getItemPropAttributes(config);
...
const PhoneNumber = (_a) => {
  var { anchorStyle, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, inputMode, lang, phoneNumber, referrerPolicy, rel, spellCheck, style, tabIndex, target, tel, title } = _a, config = __rest$8(_a, ["anchorStyle", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "inputMode", "lang", "phoneNumber", "referrerPolicy", "rel", "spellCheck", "style", "tabIndex", "target", "tel", "title"]);
  const itemprops = getItemPropAttributes(config);
  return tel ? (h("a", { class: "anchor-bender", draggable: draggable, hidden: hidden, href: `tel:${phoneNumber}`, id: componentId, referrerPolicy: referrerPolicy, rel: getRel(rel), style: anchorStyle, tabIndex: tabIndex || 0, target: target },
    h("span", Object.assign({ class: "phone-number-bender", contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }), phoneNumber))) : (h("span", Object.assign({ class: "phone-number-bender", contenteditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputmode: inputMode }, itemprops, { lang: lang, spellcheck: spellCheck, style: style, title: title }), phoneNumber));
};
...
*/
const Quotation = (_a) => {
  var { anchorStyle, autoCapitalize, children, cite, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$7(_a, ["anchorStyle", "autoCapitalize", "children", "cite", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("q", { autocapitalize: autoCapitalize, cite: cite, class: "quotation-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("q", Object.assign({ autocapitalize: autoCapitalize, cite: cite, class: "quotation-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Sample = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$6(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("samp", { autocapitalize: autoCapitalize, class: "sample-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("samp", Object.assign({ autocapitalize: autoCapitalize, class: "sample-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const SmallText = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$5(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("small", { autocapitalize: autoCapitalize, class: "small-text-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("small", Object.assign({ autocapitalize: autoCapitalize, class: "small-text-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Subscript = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$4(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("sub", { autocapitalize: autoCapitalize, class: "subscript-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("sub", Object.assign({ autocapitalize: autoCapitalize, class: "subscript-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
/*
  ...
  Accepts phrasing content.
*/
const Superscript = (_a) => {
  var { anchorStyle, autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title } = _a, config = __rest$3(_a, ["anchorStyle", "autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("sup", { autocapitalize: autoCapitalize, class: "superscript-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, injectComponentsIntoContent(children)))) : (h("sup", Object.assign({ autocapitalize: autoCapitalize, class: "superscript-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), injectComponentsIntoContent(children)));
};
...
*/
const Typography = (_a) => {
  var { autoCapitalize, children, componentId, contentEditable, dir, draggable, enterKeyHint, face = 'default-font', fontVariantAlternates = ['inherit'], fontVariantCaps = ['inherit'], fontVariantLigatures = ['inherit'], fontVariantNumeric = ['inherit'], hidden, inputMode, isBold, isItalic, lang, role, size = 0, spellCheck, style, tabIndex, title } = _a, config = __rest$2(_a, ["autoCapitalize", "children", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "face", "fontVariantAlternates", "fontVariantCaps", "fontVariantLigatures", "fontVariantNumeric", "hidden", "inputMode", "isBold", "isItalic", "lang", "role", "size", "spellCheck", "style", "tabIndex", "title"]);
  const itemprops = getItemPropAttributes(config);
  const styles = Object.assign({ fontFamily: `var(--${face})`, fontSize: `var(--s${size})`, fontStyle: isItalic ? 'italic' : 'normal', fontVariantAlternates: fontVariantAlternates.join(' '), fontVariantCaps: fontVariantCaps.join(' '), fontVariantLigatures: fontVariantLigatures.join(' '), fontVariantNumeric: fontVariantNumeric.join(' '), fontWeight: isBold ? 'bold' : 'normal' }, style);
  return (h("span", Object.assign({ autocapitalize: autoCapitalize, class: "typography-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: styles, tabIndex: tabIndex, title: title }), children));
};
...
*/
const Variable = (_a) => {
  var { anchorStyle, autoCapitalize, componentId, contentEditable, dir, draggable, enterKeyHint, hidden, href, hrefLang, inputMode, lang, referrerPolicy, rel, role, spellCheck, style, tabIndex, target, title, variable } = _a, config = __rest$1(_a, ["anchorStyle", "autoCapitalize", "componentId", "contentEditable", "dir", "draggable", "enterKeyHint", "hidden", "href", "hrefLang", "inputMode", "lang", "referrerPolicy", "rel", "role", "spellCheck", "style", "tabIndex", "target", "title", "variable"]);
  const itemprops = getItemPropAttributes(config);
  return href ? (h("a", Object.assign({ class: "anchor-bender", draggable: draggable, hidden: hidden, href: href, hreflang: hrefLang, id: componentId }, itemprops, { referrerPolicy: referrerPolicy, rel: getRel(rel), role: role, style: anchorStyle, tabIndex: tabIndex || 0, target: target }),
    h("var", { autocapitalize: autoCapitalize, class: "variable-bender", contentEditable: contentEditable, dir: dir, enterkeyhint: enterKeyHint, inputMode: inputMode, lang: lang, spellcheck: spellCheck, style: style, title: title }, variable))) : (h("var", Object.assign({ autocapitalize: autoCapitalize, class: "variable-bender", contentEditable: contentEditable, dir: dir, draggable: draggable, enterkeyhint: enterKeyHint, hidden: hidden, id: componentId, inputMode: inputMode }, itemprops, { lang: lang, role: role, spellcheck: spellCheck, style: style, tabIndex: tabIndex, title: title }), variable));
};
...
const ComponentRenderer = ({ componentId, merge = {}, }) => {
  const _a = state.config.components[componentId] ||
    {}, { componentType: Tag } = _a, config = __rest(_a, ["componentType"]);
  const Component = functionalComponents[Tag];
  if (Component) {
    return h(Component, Object.assign({}, config, { state: state }));
  }
  return config && Tag ? (h(Tag, { config: Object.assign(Object.assign({}, config), merge) })) : undefined;
};

export { ComponentRenderer as C, Typography as T, commonjsGlobal as a, createCommonjsModule as c, getDefaultExportFromCjs as g, state as s };
